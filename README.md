...
<div align="left">
    <p>
        pretty-lang is the TOOL-tier crate: AST/CST-to-source rendering - a gofmt-style formatter for every language nearly free. Part of the -lang language-construction family; see _strategy/LANG_COLLECTION.md for the master plan.
    </p>
    <br>
    <hr>
    <p>
